...
At least one of --macro, --futures-asset or --symbol is required - the script
does nothing by default so it can't be run unattended by accident.
"""
...
from app.services.market_data.config import FUTURES_ASSETS
...
def main(argv: list[str] | None = None) -> int:
    ...
    if not (args.futures_asset or args.symbol or args.macro):
        parser.error("Specify at least one of --futures-asset, --symbol, or --macro")
